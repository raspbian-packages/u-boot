...
# u-boot-amlogic
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += khadas-vim-noefi
  khadas-vim-noefi_targets := u-boot.bin uboot.elf
  khadas-vim-noefi: configs/khadas-vim-noefi_defconfig
  configs/khadas-vim-noefi_defconfig: configs/khadas-vim_defconfig
	cp configs/khadas-vim_defconfig configs/khadas-vim-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/khadas-vim-noefi_defconfig
  dh_clean_args += configs/khadas-vim-noefi_defconfig
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += khadas-vim2-noefi
  khadas-vim2-noefi_targets := u-boot.bin uboot.elf
  khadas-vim2-noefi: configs/khadas-vim2-noefi_defconfig
  configs/khadas-vim2-noefi_defconfig: configs/khadas-vim2_defconfig
	cp configs/khadas-vim2_defconfig configs/khadas-vim2-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/khadas-vim2-noefi_defconfig
  dh_clean_args += configs/khadas-vim2-noefi_defconfig
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += libretech-cc-noefi
  libretech-cc-noefi_targets := u-boot.bin uboot.elf
  libretech-cc-noefi: configs/libretech-cc-noefi_defconfig
  configs/libretech-cc-noefi_defconfig: configs/libretech-cc_defconfig
	cp configs/libretech-cc_defconfig configs/libretech-cc-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/libretech-cc-noefi_defconfig
  dh_clean_args += configs/libretech-cc-noefi_defconfig
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += nanopi-k2-noefi
  nanopi-k2-noefi_targets := u-boot.bin uboot.elf
  nanopi-k2-noefi: configs/nanopi-k2-noefi_defconfig
  configs/nanopi-k2-noefi_defconfig: configs/nanopi-k2_defconfig
	cp configs/nanopi-k2_defconfig configs/nanopi-k2-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/nanopi-k2-noefi_defconfig
  dh_clean_args += configs/nanopi-k2-noefi_defconfig
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += odroid-c2-noefi
  odroid-c2-noefi_targets := u-boot.bin uboot.elf
  odroid-c2-noefi: configs/odroid-c2-noefi_defconfig
  configs/odroid-c2-noefi_defconfig: configs/odroid-c2_defconfig
	cp configs/odroid-c2_defconfig configs/odroid-c2-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/odroid-c2-noefi_defconfig
  dh_clean_args += configs/odroid-c2-noefi_defconfig
  ...
  # Build variant without EFI enabled to workaround bug
  # https://bugs.debian.org/1027176
  u-boot-amlogic_platforms += odroid-n2-noefi
  odroid-n2-noefi_targets := u-boot.bin uboot.elf
  odroid-n2-noefi: configs/odroid-n2-noefi_defconfig
  configs/odroid-n2-noefi_defconfig: configs/odroid-n2_defconfig
	cp configs/odroid-n2_defconfig configs/odroid-n2-noefi_defconfig
	echo '# CONFIG_EFI_LOADER is not set' >> configs/odroid-n2-noefi_defconfig
  dh_clean_args += configs/odroid-n2-noefi_defconfig
